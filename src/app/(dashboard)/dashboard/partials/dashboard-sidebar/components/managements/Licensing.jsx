...
import { licensingRoutes } from "../routes/licensingRoutes";
import { useRef } from "react";
import useIsSubMenuOpen from "@/hooks/useIsSubMenuOpen";

const LicensingManagementRoutes = ({ sidebarOpen }) => {
  // REF
...
export default LicensingManagementRoutes;
