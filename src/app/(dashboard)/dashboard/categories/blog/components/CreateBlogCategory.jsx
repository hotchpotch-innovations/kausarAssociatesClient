...
const CreateBlogCategory = () => {
  const submitHandler = async (data) => {
    ...
    try {
      ...
      location.reload();
      document.getElementById("create-blog-category").close();
  ...
  return (
    <>
      <button
        ...
        onClick={() =>
          document.getElementById("create-blog-category").showModal()
        }
      >
        Create Category
      </button>

      <dialog id={"create-blog-category"} className="modal">
