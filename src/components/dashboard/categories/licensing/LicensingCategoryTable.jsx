...
import UpdateLicensingCategory from "./UpdateLicensingCategory";

const LicensingCategoryTable = async ({ api }) => {
              ...
              return (
                <tr key={item._id} className="grid grid-cols-6 gap-3">
                  ...
                  <td className="col-span-1 space-x-4 p-2 whitespace-nowrap">
                    <UpdateLicensingCategory modalId={item?._id} data={item} />
...
export default LicensingCategoryTable;
