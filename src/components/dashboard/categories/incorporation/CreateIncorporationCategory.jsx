...
const CreateIncorporationCategoryForm = () => {
  const submitHandler = async (data) => {
    ...
    try {
      ...
      location.reload();
      document.getElementById("create-incorporation-category").close();
  ...
  return (
    <>
      <button
        ...
        onClick={() =>
          document.getElementById("create-incorporation-category").showModal()
        }
      >
        Create Category
      </button>

      <dialog id={"create-incorporation-category"} className="modal">
          ...
          <div method="dialog">
            ...
            <div>
              <button
                onClick={() =>
                  document
                    .getElementById("create-incorporation-category")
                    .close()
                }
...
export default CreateIncorporationCategoryForm;
