...
const CreateCompanyNewsCategory = () => {
  const submitHandler = async (data) => {
    ...
    try {
      ...
      location.reload();
      document.getElementById("create-company-news-category").close();
  ...
  return (
    <>
      <button
        ...
        onClick={() =>
          document.getElementById("create-company-news-category").showModal()
        }
      >
        Create Category
      </button>

      <dialog id={"create-company-news-category"} className="modal">
          ...
          <div method="dialog">
            ...
            <div>
              <button
                onClick={() =>
                  document
                    .getElementById("create-company-news-category")
                    .close()
                }
...
export default CreateCompanyNewsCategory;
