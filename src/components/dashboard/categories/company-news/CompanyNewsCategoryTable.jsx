...
import UpdateCompanyNewsCategory from "./UpdateCompanyNewsCategory";
// import DeleteButton from "../../../website-management/home_page/components/buttons/DeleteButton";
// import UpdateIncorporationCategoryForm from "./UpdateIncorporationCategory";

const CompanyNewsCategoryTable = async ({ api }) => {
...
export default CompanyNewsCategoryTable;
